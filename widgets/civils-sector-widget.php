<?php
class AT8_Civils_Sector_Widget extends \Elementor\Widget_Base {

    public function get_name() { return 'at8_civils_sector'; }
    public function get_title() { return 'AT8 Civils & Groundworks (Complete)'; }
    public function get_icon() { return 'eicon-工地'; }
    ...
    protected function register_controls() {
        ...
        $this->add_control('hero_bg', [
            ...
            'default' => ['url' => 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?auto=format&fit=crop&q=80&w=2000'],
        ]);
        $this->add_control('hero_title', [
            'label' => 'Main Title',
            'type' => \Elementor\Controls_Manager::WYSIWYG,
            'default' => 'CIVIL ENGINEERING <br><span class="text-at8-yellow">& GROUNDWORKS</span>',
        ]);
        $this->add_control('hero_desc', [
            'label' => 'Description',
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => 'Expert groundworks and structural civils. From precision excavation to complex site preparation and high-quality HAUC compliant reinstatement.',
        ]);
        ...
        $this->add_control('ov_title', [
            'label' => 'Title',
            'type' => \Elementor\Controls_Manager::WYSIWYG,
            'default' => 'ENGINEERING THE <br><span class="text-at8-yellow">GROUND UP</span>',
        ]);
        $this->add_control('ov_desc_1', [
            'label' => 'Paragraph 1',
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => 'AT-8 Utilities Ltd provides specialist civil engineering and groundworks services designed to support the UK\'s growing infrastructure.',
        ]);
        $this->add_control('ov_desc_2', [
            'label' => 'Paragraph 2',
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => 'We manage projects from initial site clearance through to final reinstatement, specializing in utility-centric civils including ducting networks.',
        ]);
        $this->add_control('ov_image', [
            'label' => 'Side Image',
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => ['url' => 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&q=80&w=1000'],
        ]);
        $this->end_controls_section();

        // --- CORE SERVICES REPEATER ---
        $this->start_controls_section('services_section', ['label' => '3. Core Civil Services']);
        $repeater = new \Elementor\Repeater();
        $repeater->add_control('s_icon', ['label' => 'Icon Class', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'fa-hard-hat']);
        $repeater->add_control('s_title', ['label' => 'Title', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'Excavation & Ducting']);
        ...
        $this->add_control('services_list', [
            ...
            'default' => [
                ['s_title' => 'Excavation & Ducting', 's_icon' => 'fa-hard-hat', 's_desc' => 'Deep excavation and precision trenching for multi-utility ducting systems.', 's_list' => "Deep Drainage Works\nMulti-Way Ducting"],
                ['s_title' => 'Directional Drilling', 's_icon' => 'fa-bore-hole', 's_desc' => 'Advanced trenchless technology used to install pipes under existing infrastructure.', 's_list' => "Minimal Disruption\nRiver & Rail Crossings"],
                ['s_title' => 'Reinstatement', 's_icon' => 'fa-fill', 's_desc' => 'Complete surface restoration including high-spec asphalt paving and concrete finishes.', 's_list' => "HAUC Compliant\nHighway & Footway"],
            ],
            'title_field' => '{{{ s_title }}}',
        ]);
        $this->end_controls_section();
        ...
        $this->add_control('proj_image', [
            'label' => 'Project Image',
            'type' => \Elementor\Controls_Manager::MEDIA,
            'default' => ['url' => 'https://images.unsplash.com/photo-1589923188900-85dae523342b?auto=format&fit=crop&q=80&w=1200'],
        ]);
        $this->add_control('proj_title', [
            'label' => 'Title',
            'type' => \Elementor\Controls_Manager::WYSIWYG,
            'default' => 'Kent Major <br><span class="text-at8-yellow">Development Site Prep</span>',
        ]);
        $this->add_control('proj_desc', [
            'label' => 'Description',
            'type' => \Elementor\Controls_Manager::TEXTAREA,
            'default' => 'Supporting a large-scale commercial development in Ashford, AT-8 Utilities delivered comprehensive groundworks across 5 hectares.',
        ]);
        $this->end_controls_section();

        // --- CTA SECTION ---
        $this->start_controls_section('cta_section', ['label' => '5. CTA Settings']);
        $this->add_control('cta_title', ['label' => 'CTA Title', 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'Groundworks Done Right']);
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div class="reveal">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div class="industrial-accent">
                                <h4 class="font-bold text-at8-blue uppercase text-xs tracking-widest mb-1">Standard</h4>
                                <p class="text-xs text-gray-500">HAUC & NRSWA Accredited.</p>
                            </div>
                            <div class="industrial-accent">
                                <h4 class="font-bold text-at8-blue uppercase text-xs tracking-widest mb-1">Fleet</h4>
                                <p class="text-xs text-gray-500">Modern Specialist Excavation Fleet.</p>
                            </div>
                        </div>
                    </div>
                    <div class="relative reveal" style="transition-delay: 200ms;">
                        ...
                        <div class="absolute -bottom-6 -left-6 bg-at8-blue p-8 rounded-lg shadow-xl text-white">
                            <i class="fas fa-hammer text-at8-yellow text-4xl mb-4"></i>
                            <h4 class="font-bold uppercase tracking-widest text-xs">Structural Precision</h4>
                            <p class="text-blue-200 text-xs mt-2">Delivering reliable foundations for major works.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-24 bg-gray-100">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16 reveal">
                    <h2 class="text-4xl font-black text-at8-blue uppercase">CORE <span class="text-at8-yellow">CIVIL SERVICES</span></h2>
                ...
                <div class="bg-at8-blue rounded-3xl overflow-hidden shadow-2xl flex flex-col lg:flex-row">
                    ...
                    <div class="lg:w-1/2 p-12 lg:p-16 text-white flex flex-col justify-center">
                        ...
                        <div class="grid grid-cols-2 gap-8 mb-8">
                            <div><p class="text-at8-yellow font-black uppercase text-[10px] tracking-widest mb-1">Sector</p><p class="text-xl font-bold">Commercial Civils</p></div>
                            <div><p class="text-at8-yellow font-black uppercase text-[10px] tracking-widest mb-1">Timeline</p><p class="text-xl font-bold">12 Weeks</p></div>
                        </div>
                        <a href="https://at-8utilities.com/contact-us/" class="btn-animate border-2 border-at8-yellow text-at8-yellow px-8 py-3 rounded font-bold text-center uppercase text-xs tracking-widest hover:bg-at8-yellow hover:text-at8-blue transition">Enquire About Civils</a>
                    </div>
                </div>
            </div>
        </section>
